...
if __name__ == "__main__":
    ...
    panel = Window((100, 100), (100, 100), (244, 124, 0, 100), margin=(10, 10, 30, 25), padding=(10, 10, 10, 10))
    text = Text("Hello World", (100, 450), size = 32)
    canvas.add(panel)
    canvas.add(Window((0, 0), (100, 100), (190, 123, 180, 255)))

    text = Text("Hello World", (0, 0), size = 32, margin=(10, 10, 20, 10), position=(Position.CENTER, Position.CENTER))
    canvas.add(text)
